...
brrr.radius_minimap_visualisation_color =
	{ r = 0.059, g = 0.092, b = 0.235, a = 0.275 }
brrr.rotation_speed = 0.1
brrr.pictures = {
	filename = "__RTOptimized__/graphics/zipline/ZipUnderPlayer.png",
	priority = "high",
	width = 128,
	height = 128,
	scale = 0.5,
	...
	sound = {
		{
			...
			filename = "__RTOptimized__/sound/zapline.ogg",
			volume = 0.35,
		},
	},
	fade_in_ticks = 35,
...
data:extend({
	...
	{ --------- zipline controls -------------
		...
		icon = "__RTOptimized__/graphics/zipline/controls.png",
		icon_size = 64,
		subgroup = "gun",
		order = "hi",
		stack_size = 1,
	...
	{ --------- programmabel zipline controls -------------
		...
		icon = "__RTOptimized__/graphics/zipline/autocontrols.png",
		icon_size = 64,
		subgroup = "gun",
		order = "hk",
		stack_size = 1,
	...
	{ ------ zipline over player graphic -----------
		...
		filename = "__RTOptimized__/graphics/zipline/ZipOverPlayer.png",
		size = 128, --{128,128},
		frame_count = 2,
		line_length = 2,
		animation_speed = 0.3,
...

	{
		...
		filename = "__RTOptimized__/graphics/zipline/ZipHarness.png",
		size = 70,
	},
})
succ = nil
...
RTZiplineTerminal.minable =
	{ mining_time = 0.5, result = "RTZiplineTerminalItem" }
RTZiplineTerminal.collision_box = { { -0.9, -0.3 }, { 0.9, 0.9 } }
RTZiplineTerminal.selection_box = { { -1, -0.5 }, { 1, 1 } }
RTZiplineTerminal.pictures = {
	layers = {
		{
			filename = "__RTOptimized__/graphics/zipline/terminal.png",
			priority = "extra-high",
			width = 125,
			height = 250,
			direction_count = 1,
		...
		{
			filename = "__RTOptimized__/graphics/zipline/OwTheEdge.png",
			priority = "extra-high",
			width = 212,
			height = 48,
			direction_count = 1,
