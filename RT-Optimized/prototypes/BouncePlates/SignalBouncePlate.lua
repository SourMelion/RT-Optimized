...
data:extend({
			...
			layers =
				{
					...
					{
						filename = "__RT-Optimized__/graphics/BouncePlates/SignalBouncePlate/SignalPlate.png",
						priority = "medium",
						width = 66,
						height = 76,
	...
	{ --------- bounce effect ----------
		...
		pictures =
			{
			  filename = "__RT-Optimized__/graphics/BouncePlates/SignalBouncePlate/SignalParticle.png",
			  --width = 64,
			  --height = 64,
			  size = 32,
			  priority = "extra-high",
