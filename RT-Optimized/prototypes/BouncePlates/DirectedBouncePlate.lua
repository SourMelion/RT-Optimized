...
data:extend({
	...
	{ --------- Bounce plate entity --------------
		...
		icon = "__RT-Optimized__/graphics/BouncePlates/DirectedBouncePlate/DirectedPlateIconn.png",
		icon_size = 64,
		...
		picture =
			{
			  ...
			  {
				{
					filename = "__RT-Optimized__/graphics/BouncePlates/DirectedBouncePlate/DirectedPlateShadow.png",
					priority = "medium",
					width = 64,
					height = 64,
				...
				{
					filename = "__RT-Optimized__/graphics/BouncePlates/DirectedBouncePlate/DirectedPlate.png",
					priority = "medium",
					width = 64,
					height = 64,
					scale = 0.5
