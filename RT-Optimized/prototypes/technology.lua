...
data:extend({
  {
	type = "technology",
	name = "se-no",
	icon = "__RT-Optimized__/graphics/tech/start.png",
	icon_size = 128,
	effects =
	{
		{
  ...
  },
  {
	...
	icon = "__RT-Optimized__/graphics/tech/focus.png",
	icon_size = 128,
	effects =
	{
		{
		...
		},
		{
			...
			icon = "__RT-Optimized__/graphics/RangeSignaling.png",
			icon_size = 64,
		}
	},
  ...
  },
  {
	type = "technology",
	name = "HatchRTTech",
	icon = "__RT-Optimized__/graphics/hatch/icon.png",
	icon_size = 64,
	effects =
	{
		{
  ...
  },
  {
	...
	icon = "__RT-Optimized__/graphics/hatch/EjeectorIccon.png",
	icon_size = 43,
	effects =
	{
		{
  ...
  },
  {
	type = "technology",
	name = "RTThrowerTime",
	icon = "__RT-Optimized__/graphics/tech/ThrowerTech.png",
	icon_size = 128,
	effects =
	{
	},
  ...
  },
   {
    type = "technology",
    name = "RTSimonSays",
    icon = "__RT-Optimized__/graphics/BouncePlates/DirectorBouncePlate/DirectorPlateIcon.png",
    icon_size = 64,
    effects =
    {
      {
	...
	data:extend({
	  {
   	...
   	--[[ {
   		...
   		icon = "__RT-Optimized__/graphics/BouncePlates/SignalBouncePlate/SignalPlateIconn.png",
   		icon_size = 64,
   		effects =
   		{
   			{
      ...
      }, ]]
      {
         ...
         icon = "__RT-Optimized__/graphics/tech/PrimerThrower.png",
         icon_size = 128,
         effects =
         {
          {
		...
		data:extend({
			{
				...
				icon = "__RT-Optimized__/graphics/tech/boom.png",
				icon_size = 128,
				effects =
				{
					{
	...
	data:extend({
		{
			...
			icon = "__RT-Optimized__/graphics/tech/FlyingFreight.png",
			icon_size = 128,
			effects =
			{
				{
		...
		},
		{
			...
			icon = "__RT-Optimized__/graphics/tech/MagnetFreight.png",
			icon_size = 128,
			effects =
			{
				{
   	...
   	data:extend({
   	  {
   		type = "technology",
   		name = "RTImpactTech",
   		icon = "__RT-Optimized__/graphics/tech/Impact.png",
   		icon_size = 128,
   		effects =
   		{
   			{
		...
		data:extend({
			{
				...
				icon = "__RT-Optimized__/graphics/tech/FlyingFreightPlate.png",
				icon_size = 128,
				effects =
				{
					{
...
if (settings.startup["RTZiplineSetting"].value == true) then
	data:extend({
   {
   	type = "technology",
   	name = "RTZiplineTech",
   	icon = "__RT-Optimized__/graphics/zipline/icon.png",
   	icon_size = 64,
   	effects =
   	{
   		{
...

   {
   	...
   	icon = "__RT-Optimized__/graphics/zipline/crankcontrols.png",
   	icon_size = 64,
   	effects =
   	{
   		{
...

   {
      ...
      icon = "__RT-Optimized__/graphics/zipline/terminaltech.png",
      icon_size = 128,
      effects =
      {
         {
