...
magRampEntities = {
	{ -- range sprite
		...
		filename = "__RT-Optimized__/graphics/TrainRamp/range.png",
		size = 64
	},
	...
	{ -- "rail" tile
		...
		name = "RTMagnetRail",
		icon = "__RT-Optimized__/graphics/TrainRamp/magnetrail.png",
		icon_size = 16,
		...
		picture =
			{
				filename = "__RT-Optimized__/graphics/TrainRamp/magnetrail2.png",
				size = 64,
				scale = 0.5
			},
	},
	...
	
	{
		type = "animation",
		name = "RTPush",
		filename = "__RT-Optimized__/graphics/TrainRamp/testhue.png",
		size = {105,169},
		frame_count = 99,
		line_length = 3
	},
	
	{
		type = "animation",
		name = "RTPull",
		filename = "__RT-Optimized__/graphics/TrainRamp/testhuerev.png",
		size = {105,169},
		frame_count = 99,
		line_length = 3
	},
	
	{
		...
		icon = "__RT-Optimized__/graphics/TrainRamp/RTMagnetTrainRamp-icon.png",
		icon_size = 64,
		flags = {"placeable-neutral", "placeable-off-grid", "not-on-map", "not-blueprintable", "not-deconstructable", "not-flammable", "no-copy-paste"},
		selection_box = {{-0.5, -0.5}, {0.5, 0.5}},
