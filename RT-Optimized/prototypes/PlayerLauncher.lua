...
local PikachuFace = table.deepcopy(data.raw.inserter["inserter"])
	...
	PikachuFace.icon = "__RT-Optimized__/graphics/PlayerLauncher/icon.png"
	...
	PikachuFace.platform_picture.sheet =
		{
			filename = "__RT-Optimized__/graphics/PlayerLauncher/PlayerLauncher.png",
			priority = "extra-high",
			width = 105,
			height = 79,
...
data:extend({ 	
	{ --------- The thrower item -------------
		...
		icon = "__RT-Optimized__/graphics/PlayerLauncher/icon.png",
		icon_size = 32,
		icon_mipmaps = 4,
		subgroup = "RT",
		order = "c",
