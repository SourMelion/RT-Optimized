...
local datboi = table.deepcopy(data.raw.container["iron-chest"])
	...
	datboi.icon = "__RT-Optimized__/graphics/OpenContainer/icon.png"
	datboi.picture = {
		filename = "__RT-Optimized__/graphics/OpenContainer/hrOpenContainer.png",
		priority = "extra-high",
		width = 66,
		height = 76,
		scale = 0.5
...
data:extend({ 
	...
	{ --------- The container item -------------
		...
		icon = "__RT-Optimized__/graphics/OpenContainer/icon.png",
		icon_size = 64, 
		icon_mipmaps = 4,
		subgroup = "RT",
		order = "b",
