...
picture =
	{
		filename = "__RT-Optimized__/graphics/hatch/hatch.png",
		width = 28,
		height = 42,
		scale = 0.75
	}
...
------------------ Ejector hatch ---------------------
{
	...
	platform_picture =
	{
		sheet =
		{
			filename = "__RT-Optimized__/graphics/hatch/EjectorHatch.png",
			priority = "extra-high",
			width = 64,
			height = 64,
			scale = 0.75
...
--[[ ------------------ Filter Ejector hatch ---------------------
{
	...
	icon = "__RT-Optimized__/graphics/hatch/FilterEjeectorIccon.png",
	icon_size = 43,
	flags = {"placeable-neutral", "player-creation"},
	collision_mask = {layers={[RememberNoUnderscores]=true}},
	collision_box = {{-0.35, -0.35}, {0.35, 0.35}},
	...
	platform_picture =
	{
		sheet =
		{
			filename = "__RT-Optimized__/graphics/hatch/FilterEjectorHatch.png",
			priority = "extra-high",
			width = 64,
			height = 64,
			scale = 0.75
