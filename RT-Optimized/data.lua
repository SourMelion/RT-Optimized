...
},
{
	type = "animation",
	name = "RTMOREPOWER",
	filename = "__RT-Optimized__/graphics/NoPowerBlink.png",
	size = {64,64},
	frame_count = 2,
	line_length = 2,
...
},
{
	type = "animation",
	name = "RTHoojinTime",
	filename = "__RT-Optimized__/graphics/TrainRamp/trains/base/WatchHimHooj.png",
	size = {128,222},
	frame_count = 7,
	line_length = 7,
	shift = {0, -1.5},
...
},
{
	...
	working_sound =
	{
		sound =
		{
			filename = "__RT-Optimized__/graphics/TrainRamp/trains/base/Crank dat Hooja Boi.ogg",
			volume = 0.5,
		},
